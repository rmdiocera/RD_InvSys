            ...
            <div class="box">
              <div class="box-body">
                <table class="table table-borderless">
                  <th colspan="2" class="thead-light">Edit Product</th>
                  <?php foreach ($product as $item) : ?>
                    <form method="POST" action="<?= site_url(); ?>products/update/<?= $item->id ?>">
                      <tr>
                        <td>Product Name: </td>
                        <td class="pull-right"><input type="text" name="name" value="<?= $item->name ?>"></td>
                      </tr>
                      <tr>
                        <td>Product Price: </td>
                        <td class="pull-right"><input type="text" name="price" value="<?= $item->price ?>"></td>
                      </tr>
                      <tr>
                        <td>Product Description: </td>
                        <td class="pull-right"><input type="text" name="desc" value="<?= $item->description ?>"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td>
