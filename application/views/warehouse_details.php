              ...
              <div class="box-body">
                <table class="table table-borderless">
                  ...
                  <?php foreach ($warehouse as $warehouse) : ?>
                    <form method="POST" action="<?= site_url(); ?>warehouse/update/<?= $warehouse->id ?>">
                      <tr>
                        <td>Product Name: </td>
                        <td class="pull-right"><input type="text" name="name" value="<?= $warehouse->name ?>"></td>
                      </tr>
                      <tr>
                        <td>Product Address: </td>
                        <td class="pull-right"><input type="text" name="address" value="<?= $warehouse->address ?>"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td>
