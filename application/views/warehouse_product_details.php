            ...
            <div class="box">
              <div class="box-body">
                <table class="table table-borderless">
                  <th colspan="2" class="thead-light">Edit Warehouse</th>
                  <?php foreach ($product as $product) : ?>
                    <form method="POST" action="<?= site_url(); ?>warehouse/update_warehouse_product/<?= $product->product_id ?>/<?= $product->warehouse_id ?>">
                      <tr>
                        <td>Product Name: </td>
                        <td class="pull-right"><input type="text" name="name" value="<?= $product->name ?>" disabled></td>
                      </tr>
                      <tr>
                        <td>Product Quantity: </td>
                        <td class="pull-right"><input type="text" name="quantity" value="<?= $product->quantity ?>"></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td>
